...
*/
class MoonbaseLoadingBar : public ResourceGroupListener
{
protected:
...
public:
	...
	*/
		...
		Real initProportion = 0.70f)
	{
		...
		if (!mLoadOverlay)
		{
			OGRE_EXCEPT(Exception::ERR_ITEM_NOT_FOUND, "Cannot find loading overlay", "MoonbaseLoadingBar::start");
		}
		mLoadOverlay->show();
