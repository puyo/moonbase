#ifndef __MoonbaseFrameListener_H__
#define __MoonbaseFrameListener_H__
    ...
    public Ogre::WindowEventListener 
{
    ...
    public:
        ...
        MoonbaseFrameListener(Ogre::RenderWindow* win, Ogre::Camera* cam, bool bufferedKeys
                = false, bool bufferedMouse = false, bool bufferedJoy = false):
            mCamera(cam), mTranslateVector(Ogre::Vector3::ZERO), mWindow(win),
            mStatsOn(true), mNumScreenShots(0), mMoveScale(0.0f),
            mRotScale(0.0f), mTimeUntilNextToggle(0), mFiltering(Ogre::TFO_BILINEAR),
            ...
            mJoy(0)
    {
        ...
        virtual bool processUnbufferedKeyInput(const Ogre::FrameEvent& evt) {
            ...
            if(displayCameraDetails)
                mDebugText = "P: " + Ogre::StringConverter::toString(mCamera->getDerivedPosition()) + " " + "O: " + Ogre::StringConverter::toString(mCamera->getDerivedOrientation());
